...
class Client(object):
    ...
    def _make_post(self, params):
        ...
        #body = "count=10&lat=37.351&user_id=1&long=-119.827&waffle=eggo"
        body = "count=10&lat=37.351&user_id=1&long=-119.827&waffle=eggo\x80\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x02(&waffle=liege"
        print body

        sig = self._signature(body)
        #sig += ""
        sig = "79be7738dd8d91612e368b68ec640e53614843ec"
        print sig
        body += '|sig:' + sig
